...
// Template files
var serverMethod = Handlebars.compile(fs.readFileSync('./build_tasks/codegen_templates/server_method.js','utf-8'));
var serverModule = Handlebars.compile(fs.readFileSync('./build_tasks/codegen_templates/server_module.js','utf-8'));
